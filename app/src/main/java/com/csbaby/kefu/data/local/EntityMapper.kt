...
object EntityMapper {
    ...
    // LLMFeature mapping
    fun LLMFeatureEntity.toDomain() = LLMFeature(
        id = id,
        featureKey = featureKey,
    ...
    fun LLMFeature.toEntity() = LLMFeatureEntity(
        id = id,
        featureKey = featureKey,
        displayName = displayName,
        description = description,
    ...
    // FeatureVariant mapping
    fun FeatureVariantEntity.toDomain() = FeatureVariant(
        id = id,
        featureId = featureId,
        variantName = variantName,
        variantType = VariantType.valueOf(variantType),
    ...
    fun FeatureVariant.toEntity() = FeatureVariantEntity(
        id = id,
        featureId = featureId,
        variantName = variantName,
    ...
    // OptimizationMetrics mapping
    fun OptimizationMetricsEntity.toDomain() = OptimizationMetrics(
        id = id,
        featureKey = featureKey,
        variantId = variantId,
        date = date,
    ...
    fun OptimizationMetrics.toEntity() = OptimizationMetricsEntity(
        id = id,
        featureKey = featureKey,
        variantId = variantId,
        date = date,
    ...
    // OptimizationEvent mapping
    fun OptimizationEventEntity.toDomain() = OptimizationEvent(
        id = id,
        featureKey = featureKey,
    ...
    fun OptimizationEvent.toEntity() = OptimizationEventEntity(
        id = id,
        featureKey = featureKey,
    ...
    // ReplyFeedback mapping
    fun ReplyFeedbackEntity.toDomain() = ReplyFeedback(
        id = id,
        replyHistoryId = replyHistoryId,
        variantId = variantId,
        userAction = FeedbackAction.valueOf(userAction),
    ...
    fun ReplyFeedback.toEntity() = ReplyFeedbackEntity(
        id = id,
        replyHistoryId = replyHistoryId,
        variantId = variantId,
